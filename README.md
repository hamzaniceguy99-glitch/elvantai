# Elvantai — couples coaching

Static marketing site (HTML / CSS / JS, no build step) hosted on GitHub Pages
at `elvantai.shop`.

> Generated from `C:\Users\souha\coaching-sites-factory` (content file `sites/elvantai.mjs`).
> To change the content, edit that file and run `node build.mjs elvantai` — editing the
...
| 🟠 Important | `contact@elvantai.shop` doesn't exist yet: set up free email forwarding in Namecheap (*Domain List → Manage → Redirect Email*). | Namecheap |
...
| 🟡 Later | Prices ($49 / $139 / $269) and plan contents should match what you actually sell. | `index.html` `#pricing` |
...
```
Coaching in communication for couples, delivered online: video sessions with both partners and small group sessions covering everyday communication habits, recurring arguments, dividing money and household responsibilities, and protecting time together. Couples follow a 6 to 10 week program with weekly exercises and written check-ins. This is relationship coaching, not couples therapy, counseling or mental health treatment, and it is not appropriate where there is abuse. Services are sold as month-to-month subscriptions from $49 to $269 per month per couple, cancellable at any time. No physical products are sold or shipped. Site: elvantai.shop
```
